...
(function() {
  ...
  if ((_base = window.dealersjs).mobile == null) {
    _base.mobile = Mobile = (function() {
      ...
      Mobile.isWindows = function() {
        return this.user_agent.indexOf('windows') > -1;
      };

      Mobile.isMac = function() {
        return this.user_agent.indexOf('macintosh') > -1;
      };
  ...
  ComponentGroup = (function() {
    ...
    ComponentGroup.prototype.update = function(opts) {
      var item, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4, _results, _results1;
      switch (opts.type) {
        case 'blinkAll':
          _ref = this.group;
          _results = [];
  ...
  Instructions = (function(_super) {
    ...
    Instructions.prototype.initialize = function(opts) {
      var it, newLabel, nl, npos, texto, triangle, _i, _len, _ref, _ref1;
      this.Container_initialize();
      this.x = opts.x;
      this.y = opts.y;
      ...
      this.playing = false;
      this.currentState = 0;
      this.custom = (_ref = this.states[this.currentState].custom) != null ? _ref : false;
      ...
      if (this.custom === true) {
        ...
        npos = 14;
        newLabel = [];
        _ref1 = this.states[this.currentState].text;
  ...
  WriteContainer = (function(_super) {
    ...
    WriteContainer.prototype.initialize = function(opts) {
      var align, fcolor, font, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
      this.Container_initialize();
      Module.extend(this, d2oda.methods);
      Module.extend(this, d2oda.actions);
      this.x = opts.x;
      this.y = opts.y;
      this.name = (_ref = opts.name) != null ? _ref : opts.id;
      font = (_ref1 = opts.font) != null ? _ref1 : 'Arial 20px';
      fcolor = (_ref2 = opts.color) != null ? _ref2 : '#333';
      this.stroke = (_ref3 = opts.stroke) != null ? _ref3 : 3;
      this.scolor = (_ref4 = opts.scolor) != null ? _ref4 : '#333';
  ...
  ImageContainer = (function(_super) {
    ...
    ImageContainer.prototype.initialize = function(opts) {
      var align, b, _ref, _ref1, _ref2, _ref3;
      this.Container_initialize();
      Module.extend(this, d2oda.methods);
      Module.extend(this, d2oda.actions);
      align = (_ref = opts.align) != null ? _ref : '';
      this.name = (_ref1 = opts.name) != null ? _ref1 : opts.id;
      this.x = opts.x;
      this.y = opts.y;
      this.scaleX = (_ref2 = opts.scale) != null ? _ref2 : 1;
      this.scaleY = (_ref3 = opts.scale) != null ? _ref3 : 1;
  ...
  TextContainer = (function(_super) {
    ...
    TextContainer.prototype.initialize = function(opts) {
      var align, fcolor, font, h, maxWidth, npos, t, ypos, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _results;
      this.Container_initialize();
      Module.extend(this, d2oda.methods);
      Module.extend(this, d2oda.actions);
      font = (_ref = opts.font) != null ? _ref : '20px Arial';
      fcolor = (_ref1 = opts.fcolor) != null ? _ref1 : '#333';
      ...
      this.parrafo = (_ref6 = opts.parrafo) != null ? _ref6 : false;
  ...
  SpriteContainer = (function(_super) {
    ...
    SpriteContainer.prototype.initialize = function(opts) {
      var align, container, _ref, _ref1, _ref2, _ref3;
      this.Container_initialize();
      Module.extend(this, d2oda.methods);
      Module.extend(this, d2oda.actions);
      align = (_ref = opts.align) != null ? _ref : '';
    ...
    SpriteContainer.prototype.update = function(opts) {
      var _ref;
      this.complete = (_ref = opts.complete) != null ? _ref : false;
  ...
  SpriteAnimContainer = (function(_super) {
    ...
    SpriteAnimContainer.prototype.initialize = function(opts) {
      var framerate, img, label, spriteImgs, _ref, _ref1;
      this.Container_initialize();
      Module.extend(this, d2oda.methods);
      Module.extend(this, d2oda.actions);
      ...
      framerate = (_ref1 = opts.framerate) != null ? _ref1 : 24;
    ...
    SpriteAnimContainer.prototype.playAnimation = function(name) {
      var i, _i, _ref;
      if (name) {
        for (i = _i = 0, _ref = this.labels.length; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
          if (label === name) {
            this.currentLabel = i;
          }
        }
  ...
  DragContainer = (function(_super) {
    ...
    DragContainer.prototype.initialize = function(opts) {
      var b, container, sh, t, _i, _len, _ref, _ref1, _ref2;
      this.Container_initialize();
      Module.extend(this, d2oda.methods);
      Module.extend(this, d2oda.actions);
      Module.extend(this, d2oda.utilities);
      ...
      this["eval"] = opts["eval"];
      this.droptargets = new Array();
      this.disableDrag = (_ref1 = opts.disableDrag) != null ? _ref1 : false;
    ...
    DragContainer.prototype.evaluateDrop = function(e) {
      var drop, dropped, pt, target, _i, _len, _ref;
      target = null;
      dropped = false;
  ...
  ButtonContainer = (function(_super) {
    ...
    ButtonContainer.prototype.initialize = function(opts) {
      ...
      this.x = opts.x;
      this.y = opts.y;
      this.visible = (_ref = opts.visible) != null ? _ref : true;
      this.index = opts.index;
      this.name = (_ref1 = opts.name) != null ? _ref1 : opts.id;
      this.scale = (_ref2 = opts.scale) != null ? _ref2 : 1;
      this.states = opts.states;
      this.currentState = 0;
    ...
    ButtonContainer.prototype.setImageText = function(img, txt) {
      var align, b, color, container, font, hit, sh, t, text, x, y, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      this.removeAllChildren();
      this.alpha = 1;
      if (img) {
        x = (_ref = img.x) != null ? _ref : 0;
        y = (_ref1 = img.y) != null ? _ref1 : 0;
        align = (_ref2 = img.align) != null ? _ref2 : '';
      ...
      if (txt) {
        text = (_ref3 = txt.text) != null ? _ref3 : '';
        font = (_ref4 = txt.font) != null ? _ref4 : '20px Arial';
        color = (_ref5 = txt.color) != null ? _ref5 : '#333';
        x = (_ref6 = txt.x) != null ? _ref6 : 0;
        y = (_ref7 = txt.y) != null ? _ref7 : 0;
        align = (_ref8 = txt.align) != null ? _ref8 : '';
  ...
  CardContainer = (function(_super) {
    ...
    CardContainer.prototype.initialize = function(opts) {
      ...
      this.target = (_ref1 = opts.target) != null ? _ref1 : 'global';
  ...
  LabelContainer = (function(_super) {
    ...
    LabelContainer.prototype.initialize = function(opts) {
      var align, color, font, _ref, _ref1, _ref2, _ref3;
      this.Container_initialize();
      Module.extend(this, d2oda.methods);
      this.x = opts.x;
      this.y = opts.y;
      this.name = (_ref = opts.name) != null ? _ref : opts.id;
      font = (_ref1 = opts.font) != null ? _ref1 : 'Arial 20px';
      color = (_ref2 = opts.color) != null ? _ref2 : '#333';
  ...
  CloneCompleterContainer = (function(_super) {
    ...
    CloneCompleterContainer.prototype.initialize = function(opts) {
      ...
      Module.extend(this, d2oda.methods);
      this.name = (_ref = opts.name) != null ? _ref : opts.id;
      this.x = (_ref1 = opts.x) != null ? _ref1 : 0;
      this.y = (_ref2 = opts.y) != null ? _ref2 : 0;
      this.uwidth = (_ref3 = opts.uwidth) != null ? _ref3 : 100;
      this.uheight = (_ref4 = opts.uheight) != null ? _ref4 : 100;
      this.observer = new ComponentObserver();
      return this.droptargets = new Array();
    };

    CloneCompleterContainer.prototype.update = function(opts) {
      var c, child, gropts, i, npos, _i, _len, _ref;
      this.removeAllChildren();
      i = 0;
      npos = 0;
      _ref = opts.containers;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        c = _ref[_i];
        if (c.opts) {
          gropts = c.opts;
  ...
  StepContainer = (function(_super) {
    ...
    StepContainer.prototype.initialize = function(opts, type, success, x, y) {
      var child, _ref, _ref1;
      this.Container_initialize();
      Module.extend(this, d2oda.methods);
      this.x = x != null ? x : 0;
      this.y = y != null ? y : 0;
      this.width = (_ref = opts.width) != null ? _ref : opts.radius;
      this.height = (_ref1 = opts.height) != null ? _ref1 : opts.radius;
      this.success = success;
      this.complete = false;
      switch (type) {
        case 'rshp':
  ...
  GridContainer = (function(_super) {
    ...
    GridContainer.prototype.initialize = function(opts) {
      var align, b, cell, color, currentCol, currentRow, font, x, y, _i, _len, _ref, _ref1, _ref10, _ref11, _ref12, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _results;
      this.Container_initialize();
      Module.extend(this, d2oda.methods);
      Module.extend(this, d2oda.utilities);
      this.x = (_ref = opts.x) != null ? _ref : 0;
      this.y = (_ref1 = opts.y) != null ? _ref1 : 0;
      this.columns = (_ref2 = opts.columns) != null ? _ref2 : 1;
      this.rows = (_ref3 = opts.rows) != null ? _ref3 : 1;
      this.uwidth = (_ref4 = opts.uwidth) != null ? _ref4 : 100;
      this.uheight = (_ref5 = opts.uheight) != null ? _ref5 : 100;
      this.name = (_ref6 = opts.name) != null ? _ref6 : opts.id;
      this.currentTarget = 0;
      this.warnings = 0;
      this.targets = new Array();
      if (opts.label) {
        font = (_ref7 = opts.label.font) != null ? _ref7 : 'Arial 20px';
        color = (_ref8 = opts.label.color) != null ? _ref8 : '#333';
        align = (_ref9 = opts.label.align) != null ? _ref9 : '';
        x = (_ref10 = opts.label.x) != null ? _ref10 : 0;
        y = (_ref11 = opts.label.y) != null ? _ref11 : 0;
  ...
  PhraseCompleterContainer = (function(_super) {
    ...
    PhraseCompleterContainer.prototype.initialize = function(opts) {
      ...
      this.x = opts.x;
      this.y = opts.y;
      this.margin = (_ref = opts.margin) != null ? _ref : 10;
      this.font = (_ref1 = opts.font) != null ? _ref1 : '20px Arial';
      this.fcolor = (_ref2 = opts.fcolor) != null ? _ref2 : '#333';
      this.bcolor = (_ref3 = opts.bcolor) != null ? _ref3 : '#FFF';
      this.scolor = (_ref4 = opts.scolor) != null ? _ref4 : '#333';
      this.stroke = (_ref5 = opts.stroke) != null ? _ref5 : 3;
      this.name = (_ref6 = opts.name) != null ? _ref6 : opts.id;
      this.align = (_ref7 = opts.align) != null ? _ref7 : '';
      this.uwidth = opts.uwidth;
      this.underline = (_ref8 = opts.underline) != null ? _ref8 : {
        y: 5
      };
      this.clickable = (_ref9 = opts.clickable) != null ? _ref9 : true;
    ...
    PhraseCompleterContainer.prototype.update = function(opts) {
      var align, first, h, h2, hopts, i, maxWidth, npos, t, txt, ypos, _i, _len, _ref, _ref1, _ref2;
      this.removeAllChildren();
      if (opts.h2) {
        align = (_ref = opts.h2.align) != null ? _ref : '';
      ...
      i = 0;
      npos = 0;
      ypos = (_ref1 = opts.ypos) != null ? _ref1 : -5;
      maxWidth = 0;
      _ref2 = opts.pattern;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        t = _ref2[_i];
    ...
    PhraseCompleterContainer.prototype.getEnabledTarget = function() {
      var enabled, target, _i, _len, _ref;
      enabled = {
        success: false
      };
      _ref = this.droptargets;
  ...
  PhraseCloneContainer = (function(_super) {
    ...
    PhraseCloneContainer.prototype.update = function(opts) {
      var align, h, h2, i, maxWidth, npos, t, txt, ypos, _i, _len, _ref, _ref1, _ref2, _ref3;
      this.removeAllChildren();
      if (opts.h2) {
        align = (_ref = opts.h2.align) != null ? _ref : '';
        h2 = this.createText('h2', opts.h2.text, this.font, this.color, opts.h2.x, opts.h2.y, align);
      ...
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        ...
        if ((_ref3 = t.charAt(0)) === '.' || _ref3 === ',' || _ref3 === '?' || _ref3 === '!') {
          console.log('coma');
          h.x = h.x - this.margin;
        }
      }
  ...
  TextCloneContainer = (function(_super) {
    ...
    TextCloneContainer.prototype.initialize = function(opts, font, fcolor, bcolor, scolor, stroke, x, y) {
      ...
      this.x = x;
      this.y = y;
      this.success = (_ref = opts.success) != null ? _ref : opts.text;
      this.text = this.createText('txt', opts.text, font, fcolor, 0, -2);
      this.width = (_ref1 = opts.width) != null ? _ref1 : this.text.getMeasuredWidth();
      this.height = (_ref2 = opts.height) != null ? _ref2 : this.text.getMeasuredHeight();
      this.complete = false;
      this.back = new createjs.Shape();
  ...
  WordSearchContainer = (function(_super) {
    ...
    WordSearchContainer.prototype.initialize = function(opts) {
      ...
      this.fcolor = (_ref2 = opts.fcolor) != null ? _ref2 : '#333';
      this.bcolor = (_ref3 = opts.bcolor) != null ? _ref3 : '#FFF';
      this.shcolor = (_ref4 = opts.shcolor) != null ? _ref4 : '#F00';
      this.shape = (_ref5 = opts.shape) != null ? _ref5 : 'rect';
      this.uwidth = (_ref6 = opts.uwidth) != null ? _ref6 : 100;
      this.uheight = (_ref7 = opts.uheight) != null ? _ref7 : 100;
      this.radius = (_ref8 = opts.radius) != null ? _ref8 : 0;
      ...
      return this.addEventListener('mousedown', (function(_this) {
        return function(e) {
          ...
          e.addEventListener('pressup', function(ev) {
            var coord, found, foundAWord, key, lcoords, ltc, unames, upath, wcoords, word, _i, _j, _k, _len, _len1, _ref10, _ref9;
            found = false;
            ...
            for (_i = 0, _len = _ref9.length; _i < _len; _i++) {
              ...
              if (word.enabled) {
                ...
                for (key = _j = 0, _ref10 = wcoords.length; 0 <= _ref10 ? _j < _ref10 : _j > _ref10; key = 0 <= _ref10 ? ++_j : --_j) {
    ...
    WordSearchContainer.prototype.update = function(opts) {
      var column, i, j, olc, row, _i, _j, _len, _len1, _ref;
      this.removeAllChildren();
  ...
  CrossWordsContainer = (function(_super) {
    ...
    CrossWordsContainer.prototype.initialize = function(opts) {
      ...
      this.fcolor = (_ref2 = opts.fcolor) != null ? _ref2 : '#333';
      this.bcolor = (_ref3 = opts.bcolor) != null ? _ref3 : '#FFF';
      this.stroke = (_ref4 = opts.stroke) != null ? _ref4 : 2;
      this.scolor = (_ref5 = opts.scolor) != null ? _ref5 : '#FFF';
      this.uwidth = (_ref6 = opts.uwidth) != null ? _ref6 : 100;
      this.uheight = (_ref7 = opts.uheight) != null ? _ref7 : 100;
      this.allComplete = false;
      this.observer = new ComponentObserver();
    ...
    CrossWordsContainer.prototype.update = function(opts) {
      var column, i, j, k, row, tcc, txt, _i, _j, _k, _len, _len1, _ref, _ref1;
      this.removeAllChildren();
      this.words = opts.words;
      for (k = _i = 1, _ref = this.words.length; 1 <= _ref ? _i <= _ref : _i >= _ref; k = 1 <= _ref ? ++_i : --_i) {
    ...
    CrossWordsContainer.prototype.evaluateWords = function() {
      var coords, obj, word, wordComplete, _i, _j, _len, _len1, _ref, _results;
      _ref = this.words;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        word = _ref[_i];
  ...
  ABCContainer = (function(_super) {
    ...
    ABCContainer.prototype.initialize = function(opts) {
      var abc, abcarr, d, i, letter, lopts, _i, _len, _ref, _x, _y;
      this.Container_initialize();
      Module.extend(this, d2oda.methods);
      this.name = (_ref = opts.name) != null ? _ref : opts.id;
      this.x = opts.x;
  ...
  WordCompleterContainer = (function(_super) {
    ...
    WordCompleterContainer.prototype.initialize = function(opts) {
      ...
      this.x = opts.x;
      this.y = opts.y;
      this.uwidth = (_ref1 = opts.uwidth) != null ? _ref1 : 25;
      this.bcolor = (_ref2 = opts.bcolor) != null ? _ref2 : '#FFF';
      this.scolor = (_ref3 = opts.scolor) != null ? _ref3 : '#333';
      this.fcolor = (_ref4 = opts.fcolor) != null ? _ref4 : '#333';
      this.font = (_ref5 = opts.font) != null ? _ref5 : '20px Arial';
      this.stroke = (_ref6 = opts.stroke) != null ? _ref6 : 3;
      this.align = (_ref7 = opts.align) != null ? _ref7 : '';
      this.margin = (_ref8 = opts.margin) != null ? _ref8 : 5;
      this["eval"] = opts["eval"];
      this.currentTarget = 0;
      this.observer = new ComponentObserver();
      return this.droptargets = new Array();
  ...
  ScrambledWordContainer = (function(_super) {
    ...
    ScrambledWordContainer.prototype.initialize = function(opts) {
      ...
      this.y = opts.y;
      this.uwidth = (_ref1 = opts.uwidth) != null ? _ref1 : 25;
      this.distance = (_ref2 = opts.distance) != null ? _ref2 : 0;
      this.bcolor = (_ref3 = opts.bcolor) != null ? _ref3 : '#FFF';
      this.scolor = (_ref4 = opts.scolor) != null ? _ref4 : '#333';
      this.fcolor = (_ref5 = opts.fcolor) != null ? _ref5 : '#333';
      this.font = (_ref6 = opts.font) != null ? _ref6 : '20px Arial';
      this.sentence = (_ref7 = opts.sentence) != null ? _ref7 : 'false';
    ...
    ScrambledWordContainer.prototype.update = function(opts) {
      var d, difference, h, hopts, i, letter, npos, s, scrambledLetter, scrambledSentence, scrambledWord, sentence, total, word, wordsArr, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref;
      this.removeAllChildren();
      this.target = opts.target;
  ...
  TextCompleterContainer = (function(_super) {
    ...
    TextCompleterContainer.prototype.initialize = function(opts, font, fcolor, bcolor, scolor, stroke, x, y) {
      ...
      this.clickable = (_ref3 = opts.clickable) != null ? _ref3 : true;
      this.underline = (_ref4 = opts.underline) != null ? _ref4 : false;
      this.word = '';
      if (this.underline) {
  ...
  LetterContainer = (function(_super) {
    ...
    LetterContainer.prototype.initialize = function(opts, font, fcolor, bcolor, shcolor, shape, x, y) {
      ...
      this.x = x;
      this.y = y;
      this.name = (_ref = "ltc_" + opts.name) != null ? _ref : "ltc_" + opts.text;
      this.success = (_ref1 = opts.success) != null ? _ref1 : opts.text;
      this.text = this.createText('txt', opts.text, font, fcolor, opts.width / 2, opts.height / 2 - 15, 'center');
      this.width = opts.width;
      this.height = opts.height;
      this.radius = (_ref2 = opts.radius) != null ? _ref2 : '20';
      this.complete = false;
  ...
  ImageWordCompleterContainer = (function(_super) {
    ...
    ImageWordCompleterContainer.prototype.initialize = function(opts) {
      ...
      this.name = (_ref = opts.name) != null ? _ref : opts.id;
      this.align = (_ref1 = opts.align) != null ? _ref1 : '';
      this.observer = new ComponentObserver();
      return this.droptargets = new Array();
    };

    ImageWordCompleterContainer.prototype.update = function(opts) {
      var child, container, i, npos, _i, _len, _ref;
      this.removeAllChildren();
      i = 0;
      _ref = opts.containers;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
  ...
  Scene = (function(_super) {
    ...
    Scene.prototype.initialize = function(scene) {
      var answers, c, container, g, group, _i, _j, _len, _len1, _ref, _ref1, _ref2, _results;
      this.Container_initialize();
      Module.extend(this, d2oda.methods);
      this.factory = new SceneFactory();
      this.observer = new SceneObserver();
      this.currentStep = 0;
      this.choose = (_ref = scene.answers.choose) != null ? _ref : 0;
