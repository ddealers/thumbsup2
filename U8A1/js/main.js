(function() {
  ...
  U8A1 = (function(_super) {
    ...
    U8A1.prototype.setStage = function() {
      ...
      b1 = new Button('game1btn', this.preload.getResult('game1_btn'), 1, 1506, 920);
      b2 = new Button('game2btn', this.preload.getResult('game2_btn'), 2, 1506, 1010);
      b3 = new Button('game3btn', this.preload.getResult('game3_btn'), 3, 1506, 1100);
