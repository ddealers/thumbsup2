class U5A1 extends Oda
	...
	introEvaluation: ->
		...
		TweenLite.from @library.btnRepeat, 1, {alpha :0, y: @library.btnRepeat.y + 40, delay: 2}
		TweenLite.from @library.btnFinished, 1, {alpha: 0, y: @library.btnFinished.y + 40, delay: 2, onComplete: @playInstructions, onCompleteParams: [@]}
	initEvaluation: (e) =>
		super
		for i in [1..8]
