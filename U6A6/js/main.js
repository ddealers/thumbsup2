(function() {
  ...
  U6A6 = (function(_super) {
    ...
    U6A6.prototype.createHelp = function() {
      ...
      this.addToLibrary(t);
      a = new Button('btndoctor', this.preload.getResult('btn1'), 1, 0. * 80 + 20, 40);
      a.addEventListener('click', this.showHelper);
      b = new Button('btnmechanic', this.preload.getResult('btn2'), 2, 1. * 80 + 20, 40);
      b.addEventListener('click', this.showHelper);
      c = new Button('btnchef', this.preload.getResult('btn3'), 3, 2. * 80 + 20, 40);
      c.addEventListener('click', this.showHelper);
      d = new Button('btnsalesclerk', this.preload.getResult('btn4'), 4, 3. * 80 + 20, 40);
      d.addEventListener('click', this.showHelper);
      e = new Button('btnwaiter', this.preload.getResult('btn5'), 5, 4. * 80 + 20, 40);
      e.addEventListener('click', this.showHelper);
      f = new Button('btnpolice', this.preload.getResult('btn6'), 6, 5. * 80 + 20, 40);
      f.addEventListener('click', this.showHelper);
      g = new Button('btnvet', this.preload.getResult('btn7'), 7, 6. * 80 + 20, 40);
      g.addEventListener('click', this.showHelper);
      h = new Button('btnfirefighter', this.preload.getResult('btn8'), 8, 7. * 80 + 20, 40);
